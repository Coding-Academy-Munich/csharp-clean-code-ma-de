...
//
// **Lösung:** Familie von Algorithmen, jeweils gekapselt und austauschbar
//
// **Wann:** Verschiedene Verhaltensvarianten, die gewechselt werden können
...
// ## Observer Pattern
//
// **Problem:** Objekt soll andere über Zustandsänderungen informieren,
// ohne sie zu kennen
//
// **Lösung:** 1-zu-N-Abhängigkeit; bei Änderung werden alle Abhängigen
// benachrichtigt
//
...
//
// 1. Interface `IPaymentStrategy` mit Methode `Pay(decimal amount)`
// 2. Drei Strategien: `CreditCardPayment`, `PayPalPayment`,
//    `BankTransferPayment`
// 3. `ShoppingCart`-Klasse, die eine `IPaymentStrategy` verwendet
// 4. Strategiewechsel zur Laufzeit demonstrieren
